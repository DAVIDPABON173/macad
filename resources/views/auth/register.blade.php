        ...
        <div class="auth-content">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group row">
                    <label for="name" class="col-12 col-form-label text-md-left">{{ __('Name') }}</label>
                ...
                <div class="form-group row">
                    <label for="password-confirm" class="col-12 col-form-label text-md-left">{{ __('Confirm Password') }}</label>
